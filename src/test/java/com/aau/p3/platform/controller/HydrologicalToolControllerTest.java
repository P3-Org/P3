...
import com.aau.p3.helperclasses.JavaFxInitializer;
...
/**
 * Field overallScoreField = HydrologicalToolController.class.getDeclaredField("overallScoreId");
 * overallScoreField.setAccessible(true);
 * overallScoreField.set(controller, new Label());
 */